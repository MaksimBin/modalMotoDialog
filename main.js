...
document.querySelector('.volume').innerHTML = `<button class="buttonD" onclick="audioVolume()"></button>`
...
document.querySelector('.volume').innerHTML = `<button class="buttonL" onclick="audioVolume()"></button>`
numberV++
audio.volume = 0.3
